...
def make_sample_file_from_rate(file, rate):
    ...
    #  make new file
    new_file_dir = "\\\Mac\\Home\\Desktop\\DailyTask\\1006_NewFusion\\data\\sample_data\\"
...
if __name__ == "__main__":
    dirfiles = get_file_from_path("\\\Mac\\Home\\Desktop\\DailyTask\\1006_NewFusion\\data\\raw_origin_data")
    rate = [0.3, 0.5, 0.7]
    for df in dirfiles:
        for rval in rate:
